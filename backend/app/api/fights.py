...
@router.get("/fights/search", response_model=List[schemas.FightResponse], status_code=status.HTTP_200_OK)
...
@router.get("/fights/{fight_id}", response_model=schemas.FightResponse, status_code=status.HTTP_200_OK)
...
@router.get("/fights/", response_model=List[schemas.FightResponse], status_code=status.HTTP_200_OK)
